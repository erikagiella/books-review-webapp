...
- `POST /api/v1/books/:id/reviews` - Add a review for a book
...
This is the backend server for the Books Review App. It provides RESTful API endpoints to manage books and their reviews.

Bootstrap the project repository and install dependencies:
...
Create the .env and gitignre file:
